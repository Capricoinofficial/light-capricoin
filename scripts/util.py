import time, light_capricoin as light, Queue
from light_capricoin import Interface, SimpleConfig
from light_capricoin.network import filter_protocol, parse_servers

# light.util.set_verbosity(1)

def get_peers():
    # 1. start interface and wait for connection
    q = Queue.Queue()
    interface = light.Interface('light1.capricoin.org:50002:s', q)
    interface.start()
    i, r = q.get()
