...
imp.load_module('light_capricoin', *imp.find_module('lib'))

from light_capricoin import SimpleConfig, Wallet, WalletStorage, format_satoshis
from light_capricoin import util
from light_capricoin.transaction import Transaction
from light_capricoin.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Light-Capricoin Authenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/light-capricoin/authenticator')
