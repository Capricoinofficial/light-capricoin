...
descriptions = [
    ...
    },
    {
        ...
        'description': '%s\n\n%s' % (_("The new and improved LabelSync plugin. This can sync your labels across multiple Light installs by using a remote database to save your data. Labels, transactions ids and addresses are encrypted before they are sent to the remote server."), _("The label sync's server software is open-source as well and can be found on github.com/maran/light-sync-server"))
    },
    {
        'name': 'openalias',
        'fullname': 'OpenAlias',
