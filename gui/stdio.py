...
_ = lambda x:x
#from i18n import _
from light_capricoin.wallet import WalletStorage, Wallet
from light_capricoin.util import format_satoshis, set_verbosity, StoreDict
from light_capricoin.bitcoin import is_valid
from light_capricoin.network import filter_protocol
...
class LightGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'light-capricoin create'"
            exit()
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Capricoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'light-capricoin setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'light-capricoin setconfig' to change your settings")
        return True
