...
_ = lambda x:x
#from i18n import _
from light_capricoin.util import format_satoshis, set_verbosity
from light_capricoin.util import StoreDict
from light_capricoin.bitcoin import is_valid

from light_capricoin import Wallet, WalletStorage
...
class LightGui:
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            self.show_message(_('Invalid capricoincoin address'))
            return
        try:
