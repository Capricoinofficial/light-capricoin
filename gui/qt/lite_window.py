...
try:
    ...
    print "You need to have PyQT installed to run Light in graphical mode."
...
from light_capricoin.bitcoin import is_valid
...
import re
import time
from light_capricoin.wallet import Wallet, WalletStorage
import webbrowser
...
from light_capricoin.version import ELECTRUM_VERSION as light_version
from light_capricoin.util import format_satoshis, age

from main_window import LightWindow
import shutil
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a Capricoin address or contact"))
        ...
        self.setWindowTitle("Light-Capricoin")
    ...
    def set_balances(self, btc_balance):
        ...
        self.setWindowTitle("Light %s - %s %s" % (light_version, amount, unit))
    ...
    def the_website(self):
        webbrowser.open("http://light-capricoin.space")
...
class MiniActuator:
    ...
    def set_configured_currency(self, set_quote_currency):
        ...
        # currency can be none when Light is used for the first
    ...
    def waiting_dialog(self, f):
        ...
        w = QDialog()
        w.resize(200, 70)
        w.setWindowTitle('Light-Capricoin')
