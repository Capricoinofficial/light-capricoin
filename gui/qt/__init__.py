...
from light_capricoin.plugins import run_hook, always_hook
...
class LightGui:
    ...
    def toggle_tray_icon(self):
        ...
        icon = QIcon(":icons/light_dark_icon.png") if self.dark_icon else QIcon(':icons/light_light_icon.png')
    ...
    def init_lite(self):
        ...
        if not self.check_qt_version():
            if self.config.get('lite_mode') is True:
                msg = "Light was unable to load the 'Lite GUI' because it needs Qt version >= 4.7.\nChanging your config to use the 'Classic' GUI"
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Light-Capricoin')
        self.tray.activated.connect(self.tray_activated)
        self.build_tray_menu()
        self.tray.show()

        # main window
        self.main_window = w = LightWindow(self.config, self.network, self)
        self.current_window = self.main_window
