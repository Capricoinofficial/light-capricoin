...
home = 'C:\\light-capricoin\\'

# We don't put these files in to actually include them in the script but to make the Analysis method scan them for imports
a = Analysis([home+'light-capricoin',
...
exe = EXE(pyz,
          ...
          a.binaries,
          a.datas,
          name=os.path.join('build\\pyi.win32\\light-capricoin', 'light-capricoin.exe'),
          debug=False,
          strip=None,
          upx=False,
          icon=home+'icons/light.ico',
          console=False)
          # The console True makes an annoying black box pop up, but it does make Light output command line commands, with this turned off no output will be given but commands can still be used
...
coll = COLLECT(exe,
               ...
               icon=home+'icons/light.ico',
               console=False,
               name=os.path.join('dist', 'light-capricoin'))
