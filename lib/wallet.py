...
class WalletStorage(object):
    ...
    def read(self, path):
        ...
        try:
            ...
            self.data = {}
            # In old versions of Light labels were latin1 encoded, this fixes breakage.
            labels = d.get('labels', {})
...
class Abstract_Wallet(object):
    ...
    def __init__(self, storage):
        ...
        self.light_version = ELECTRUM_VERSION
        ...
        if seed_version not in [OLD_SEED_VERSION, NEW_SEED_VERSION]:
            ...
            if seed_version == 6:
                ...
                if storage.get('master_public_keys') is None and storage.get('master_private_keys') is None and storage.get('imported_keys') is None:
                    ...
                    # creation was complete if light was run from source
                    msg += "\nPlease open this file with light 1.9.8, and move your coins to a new wallet."
