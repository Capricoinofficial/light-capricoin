...
def init_plugins(config, is_local, is_gui):
    ...
    if is_local:
        ...
        light_plugins = imp.load_module('light_capricoin_plugins', fp, pathname, description)
        loader = lambda name: imp.load_source('light_capricoin_plugins.' + name, os.path.join(pathname, name + '.py'))
    else:
        light_plugins = __import__('light_capricoin_plugins')
        loader = lambda name: __import__('light_capricoin_plugins.' + name, fromlist=['light_capricoin_plugins'])
    ...
    descriptions = light_plugins.descriptions
