...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".light-capricoin")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Light-capricoin")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Light-capricoin")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/light-capricoin/"
    else:
...
block_explorer_info = {
    'insight.capricoin.org': ('http://insight.capricoin.org',
                        {'tx': 'tx', 'addr': 'address'}),
}

def block_explorer(config):
    return config.get('block_explorer', 'insight.capricoin.org')
...
def create_URI(addr, amount, message):
    ...
    p = urlparse.ParseResult(scheme='capricoin', netloc='', path=addr, params='', query='&'.join(query), fragment='')
