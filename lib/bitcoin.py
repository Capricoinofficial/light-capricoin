...
TESTNET = False
PUBKEY_ADDR = 111 if TESTNET else 28
SCRIPT_ADDR = 196 if TESTNET else 35
...
def is_old_seed(seed):
    ...
    try:
        ...
        uses_light_words = True
    except Exception:
        uses_light_words = False
    ...
    return is_hex or (uses_light_words and (len(words) == 12 or len(words) == 24))
...
def msg_magic(message):
    ...
    return "\x19Capricoin Signed Message:\n" + encoded_varint + message
